            ...
            <div className="project-grid">  
              <div className="columns is-multiline is-mobile">
                <div className="column is-12-mobile is-half-tablet is-one-third-desktop">
                  <figure className="image is-3by2"><img className="project-thumb" alt="Anna Re Fine Jewelry logo" src="img/clients/annarefinejewelry-work.webp" />
                    <figcaption>
                ...
                <div className="column is-12-mobile is-half-tablet is-one-third-desktop"> 
                  <figure className="image is-3by2"><img className="project-thumb" alt="BethpageFCU logo" src="img/clients/bethpagefcu-work.webp" />
                    <figcaption>
                ...
                <div className="column is-12-mobile is-half-tablet is-one-third-desktop">
                  <figure className="image is-3by2"><img className="project-thumb" alt="Cold Spring Harbor Laborator logo" src="img/clients/cshl-work.webp" />
                    <figcaption>
                ...
                <div className="column is-12-mobile is-half-tablet is-one-third-desktop">
                  <figure className="image is-3by2"><img className="project-thumb" alt="HFT Connect logo" src="img/clients/hftc-work.webp" />
                    <figcaption>
                ...
                <div className="column is-12-mobile is-half-tablet is-one-third-desktop"> 
                  <figure className="image is-3by2"><img className="project-thumb" alt="Saberin logo"  src="img/clients/saberin.webp" />
                    <figcaption>
                ...
                <div className="column is-12-mobile is-half-tablet is-one-third-desktop"> 
                  <figure className="image is-3by2"><img className="project-thumb" alt="Verisk logo" src="img/clients/verisk-work.webp" />
                    <figcaption>
